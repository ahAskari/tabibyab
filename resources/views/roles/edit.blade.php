...
<div class="card text-right">
    ...
    <div class="card-body">
        <form method="post" action="{{route('roles.update', $role_id->id)}}">
            @csrf
            <div class="form-row">
                <div class="col">
                    <input type="text" name="name" class="form-control" value="{{$role_id->name}}"
                ...
                <div class="col">
                    <input type="text" name="persian_name" class="form-control" value="{{$role_id->persian_name}}"
            ...
            <div class="form-group">
                ...
                <div class="custom-control custom-checkbox custom-control-inline">
                    <input type="checkbox" name='permissions[]'
                        {{$role_id->permissions->contains($permission) ? 'checked' : ''}} value="{{$permission->name}}"
